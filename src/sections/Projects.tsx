...
import { ArrowUpRight, ChevronDown, ExternalLink, Github, Sparkles } from 'lucide-react';
...
const Projects: React.FC = () => {
  ...
  return (
    <div className="section-container" ref={ref}>
      ...
      <div id="projects-mobile-content" className={`${showProjects ? 'block' : 'hidden'} md:block`}>
